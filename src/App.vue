<template>
  <div id="app">
    ...
    <input
      ...
      class="menu"
      value="タイムライン出力"
      title="入力されたリストをテンプレートに従って整形して出力します。"
    />
    <input
      type="button"
      @click="outputSummaryResult"
      class="menu"
      value="カテゴリ別サマリ出力"
    ...
    <transition>
      <div id="settings" v-show="settings.showSettings">
        ...
        <p>
          ...
          <input
            typeop="text"
            v-model="outputTemplate.header"
            @change="onChangeOutputTemplate"
            size="80"
        ...
        <p>
          ...
          <input
            typeop="text"
            v-model="outputTemplate.summaryHeader"
            @change="onChangeOutputTemplate"
            size="80"
            title="出力の一番最初に1度だけ出力される文字列"
          />
        ...
        <p>
          ...
          <input
            type="text"
            v-model="outputTemplate.summaryBody"
            size="80"
            @change="onChangeOutputTemplate"
            title="各項目ごとに出力される文字列"
          />
        ...
        <p>
          ...
          <input
            type="text"
            v-model="outputTemplate.summaryFooter"
            size="80"
            @change="onChangeOutputTemplate"
            title="出力の一番最後に1度だけ出力される文字列"
          />
        ...
        <div style="margin-top:1em;align-content:center;">
          ...
          <input
            type="checkbox"
            v-model="settings.isSummaryFirstInAllOutput"
            @change="onChangeSettings"
